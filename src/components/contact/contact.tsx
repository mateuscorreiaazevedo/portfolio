  ...
  return (
    <Section>
      <div className="w-full flex flex-col items-center justify-center gap-4">
        <h1 className="animate-section-2 text-3xl md:text-6xl sm:-translate-y-5 lg:-translate-y-20 font-alt lg:self-start first-letter:text-violet-500 text-neutral-100">
          Contato.
        </h1>

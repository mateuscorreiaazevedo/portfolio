    ...
    <Section animation='section-1'>
      <div className="w-full flex flex-col lg:items-start items-center justify-center gap-4 md:gap-1">
        ...
        <p className="w-80 sm:w-72 sm:text-sm md:w-80 md:text-base text-justify">
          Desenvolvedor <span className="font-bold text-primary">Front-end e Mobile</span>, atuando desde 2018 com
          projetos de todos os portes. Atualmente sou freelancer como Frontend Developer desenvolvendo interfaces
          modernas e de alta qualidade, concentrado em performance, boas práticas de programação, responsividade e SEO.
          Além disso, estou me graduando no curso de Sistemas de Informação.
        </p>
      </div>
